...
from mini_wallet.schemas.transactions import TransactionsWithdrawalSchema
...
class TransactionsWithdrawalResource(Resource):   
    @login_required()
    @validate_input(SchemaMethod.LOAD, TransactionsWithdrawalSchema(), EncodingType.FORMDATA)
    def post(self, **kwargs) -> Response:
        status, result = TransactionController().do_transaction(g.customer_xid, TransactionType.withdrawal, **kwargs)
